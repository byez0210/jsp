...
public class UserVo {
	...
	/*
	 * public String getReg_dt_fmt() { // reg_dt 필드가 null이면 "" 문자열 변환 // reg_dt 필드가
	 * null이 아니면 SimpleDateFormat을 // 생성하여 yyyy.MM.dd 포맷의 문자열로 변환하려 리턴 if
	 * (this.reg_dt == null) { return ""; } else { SimpleDateFormat sdf = new
