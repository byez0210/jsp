...
<%--
 ...
 step : 증감 값(default 1)
 var : 인덱스변수 or향상된 for문에서 사용될 경우 collection 객체에서 꺼낸 값 설정
 varStatus : 루프변수
 	index - 현재 인덱스 값
 	count - 루프 실행 횟수
 ...
 <%
 	...
 	//map. list?
 	//amp : 순차적으로 접근이 아닌 ,특정 키에 의해 원하는 값을 확인 하고 싶을 떼
 	// List : 순차적으로 접근하고 싶을 때
 	// for (String str : list) ==> 리스트에 담겨있느 모든 값에 대해 처리
 	// map에 담겨진 모든 값을 확인 ??
 ...
 %>
 	...
 	<h3>url 작성</h3>
 	<a href="<c:url value="/userRegist"/>">사용자 등록</a>
 	<a href="${pageContext.request.contextPath }/userRegist">사용자 등록</a>
 	<a href="${cp }/userRegist">사용자 등록</a>
 	
 	var 속성을 적용하지 않는 경우 : 태그를 작성한 곳에 출력 <c:url value="/userRegist"/> <br>
